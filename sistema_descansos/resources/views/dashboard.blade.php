...
<div class="dashboard-container">
    ...
    <div class="uco-stats-grid">
        <div class="uco-stat-card"><div class="uco-stat-icon-wrapper" style="background: rgba(52, 12, 81, 0.1); color: #340C51;"><i class="fa-solid fa-users"></i></div>
            <div class="uco-stat-info"><span class="uco-stat-label">Total empleados</span><br><strong class="uco-stat-number">{{ $totalEmpleados ?? 0 }}</strong></div>
        </div>
        <div class="uco-stat-card"><div class="uco-stat-icon-wrapper" style="background: rgba(170, 127, 49, 0.1); color: #AA7F31;"><i class="fa-solid fa-book"></i></div>
            <div class="uco-stat-info"><span class="uco-stat-label">Derecho Total</span><br><strong class="uco-stat-number">{{ $totalDiasDerecho ?? 0 }}</strong></div>
        </div>
        <div class="uco-stat-card"><div class="uco-stat-icon-wrapper" style="background: rgba(239, 68, 68, 0.1); color: #ef4444;"><i class="fa-solid fa-calendar-xmark"></i></div>
            <div class="uco-stat-info"><span class="uco-stat-label">Tomados</span><br><strong class="uco-stat-number" style="color: #ef4444;">{{ $diasTomadosEsteAnio ?? 0 }}</strong></div>
        </div>
        <div class="uco-stat-card"><div class="uco-stat-icon-wrapper" style="background: rgba(18, 68, 22, 0.1); color: #124416;"><i class="fa-solid fa-calendar-check"></i></div>
            <div class="uco-stat-info"><span class="uco-stat-label">Restantes</span><br><strong class="uco-stat-number" style="color: #124416;">{{ $diasRestantesTotales ?? 0 }}</strong></div>
        </div>
    </div>
                ...
                <tbody>
                    @foreach($empleadosConMenosDias ?? [] as $item)
                        <tr>
                            ...
                            <td style="color: #ef4444; font-weight:700;">{{ $item->diasRestantes }}</td>
