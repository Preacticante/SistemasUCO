    ...
    <div class="uco-stats-grid">
        <div class="uco-stat-card">
            ...
            <div class="uco-stat-info">
                ...
                <strong class="uco-stat-number">{{ $totalEmpleados ?? 0 }}</strong>
            </div>
        </div>
        <div class="uco-stat-card">
            ...
            <div class="uco-stat-info">
                ...
                <strong class="uco-stat-number">{{ $totalDiasDerecho ?? 0 }}</strong>
            </div>
        </div>
        <div class="uco-stat-card">
        ...
        <div class="uco-stat-card">
            ...
            <div class="uco-stat-info">
                ...
                <strong class="uco-stat-number" style="color: #124416;">{{ $diasRestantesTotales ?? 0 }}</strong>
            </div>
        </div>
    </div>
    ...
    <div class="dashboard-main-content">
        ...
        <div class="calendar-card">
            <div class="calendar-card-header">
                ...
                <a href="{{ route('dias-especiales.index') }}" class="btn-calcular">Gestionar días especiales</a>
            </div>
            <div id="calendar"></div>
        </div>
    </div>
