...
<div class="container">
    ...
    <div class="intro-text">
        A continuación se presenta el historial de todas las solicitudes de vacaciones registradas durante el año {{ $anioActual }}.
    </div>
    ...
    <table class="balances-table" style="margin-bottom: 20px;">
        <tr>
            ...
            <td class="cell-inline-border" style="width: 8%;">{{ $totalDiasSolicitados }}</td>
    ...
    <div class="observations-box">
        El historial incluye todas las solicitudes grabadas en el sistema durante el año {{ $anioActual }}.
    </div>
