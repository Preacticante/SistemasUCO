        ...
        <tbody>
            ...
            <tr style="border-bottom: 1px solid #f1f5f9;">
                ...
                <td style="padding: 14px; text-align: center;">
                    <a href="{{ route('empleados.vacaciones', $emp->id) }}" style="background-color: #124416; color: white; text-decoration: none; padding: 6px 14px; border-radius: 4px; font-size: 0.9rem; font-weight: 500; margin-right: 5px;">
