    ...
    <div class="auth-reset-wrapper">
        ...
        <form action="{{ route('password.update') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input id="password" type="password" name="password" required placeholder="••••••••" autocomplete="new-password" class="@error('password') is-invalid @enderror" autofocus>
                @error('password')
            ...
            <div class="form-group">
                ...
                <input id="password_confirmation" type="password" name="password_confirmation" required placeholder="••••••••" autocomplete="new-password" class="@error('password_confirmation') is-invalid @enderror">
