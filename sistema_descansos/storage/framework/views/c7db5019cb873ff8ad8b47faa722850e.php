...
<body>
    <main class="page-shell">
        ...
        <?php if(session('success')): ?>
            <div class="status success"><?php echo e(session('success')); ?></div>
        <?php endif; ?>
        ...
        <section class="card-columns">
            <article class="card">
                ...
                <form action="<?php echo e(route('empleados.vacaciones.guardar', $empleado->id)); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="fecha_inicio" name="fecha_inicio" value="<?php echo e(old('fecha_inicio')); ?>" />
                    </div>

                    <div class="form-group">
                        <label for="fecha_fin">Fecha de fin</label>
                        <input type="date" id="fecha_fin" name="fecha_fin" value="<?php echo e(old('fecha_fin')); ?>" />
                    </div>
                    ...
                    <div class="meta-row" style="margin-bottom: 1.25rem;">
                        ...
                        <span class="meta-pill">Restantes estimados: <strong id="preview-restantes"><?php echo e(max(0, $diasRestantes - 1)); ?></strong></span>
                    </div>
            ...
            <article class="card">
                ...
                <div style="margin-top: 1.5rem;">
                    <a href="<?php echo e(route('empleados.vacaciones.pdf', $empleado->id)); ?>" target="_blank" rel="noopener noreferrer" class="button-secondary" style="width: auto;">Reporte PDF</a>
                </div>
            </article>
        </section>
    </main>
