...
<body>
    <main class="page-shell">
        ...
        <section class="topbar">
            ...
            <a href="<?php echo e(route('empleados.index')); ?>" class="button-link"> 
        ...
        <section class="summary-grid">
            <article class="card">
                ...
                <div class="meta-row">
                    ...
                    <span class="meta-pill">Primer periodo con saldo: <strong><?php echo e($anioPeriodoExtra ?? 'N/A'); ?></strong></span>
                    <span class="meta-pill">Saldo del periodo <?php echo e($anioPeriodoExtra ?? 'N/A'); ?>: <strong><?php echo e($diasExtra); ?> días</strong></span>
                    <span class="meta-pill status-derecho">Total asignado: <strong><?php echo e($diasDerecho); ?> días</strong></span>
                </div>
            </article>
                ...
                <form id="form-vacaciones" action="<?php echo e(route('empleados.vacaciones.guardar', $empleado->id)); ?>" method="POST">
                    ...
                    <div class="form-group" style="margin-bottom: 1.5rem;">
                        ...
                        <div id="periodos-preview" class="periodos-preview-list">
                            <?php $__currentLoopData = ($periodosDisponibles ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $periodoDisponible): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="periodo-preview-item" data-periodo-anio="<?php echo e($periodoDisponible['anio']); ?>">
                                    <span>Periodo <?php echo e($periodoDisponible['anio']); ?></span>
                                    <strong><?php echo e($periodoDisponible['dias_disponibles']); ?> días disponibles</strong>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <div class="form-instruction" style="margin-top: 5px;">
...
<script>
    ...
    const periodosDisponibles = <?php echo json_encode($periodosDisponibles ?? [], 15, 512) ?>;
